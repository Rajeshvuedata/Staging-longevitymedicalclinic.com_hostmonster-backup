        ...
        foreach ($children as $child)
        {
            ...
            if ($child->getIsActive())
            {
                ...
                if( in_array($child->getId(),$arr_catsid) ){
                    ...
                    $html.= '<a class="itemMenuName level' . $level . $active . $ClassNoChildren . '" href="' . $this->getCategoryUrl($child) . '"><span class="fa fa-angle-right"></span> <span>' . $name . '</span></a>';
                }
