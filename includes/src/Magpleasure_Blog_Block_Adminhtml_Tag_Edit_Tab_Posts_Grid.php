...
class Magpleasure_Blog_Block_Adminhtml_Tag_Edit_Tab_Posts_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Helper
            ...
            array(
                ...
                'actions' => array(
                    array(
                        ...
                        'url' => array('base' => '*/adminhtml_post/edit'),
                        'field' => 'id'
                    )
                ),
                'filter' => false,
    ...
    {
        return $this->getUrl('*/adminhtml_post/edit', array('id' => $row->getId()));
    }
    ...
    {
        return $this->getUrl('*/*/postsGrid', array('id' => $this->getRequest()->getParam('id')));
    }
